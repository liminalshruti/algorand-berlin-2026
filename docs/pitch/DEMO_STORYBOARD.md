...
- **On-chain, built + tested:** the three ARC-8004 registries (AVM TypeScript, unit specs + `scripts/localnet-e2e.ts` exercising every ABI method). Deploying them to TestNet is the milestone.
