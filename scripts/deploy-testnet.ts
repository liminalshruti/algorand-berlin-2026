...
// CAIP-2 genesis-hash prefix for TestNet (matches GENESIS.testnet in apps/web/arc8004.js).
...
async function main() {
  ...
  writeFileSync(new URL('../apps/web/deployed.testnet.json', import.meta.url), JSON.stringify(out, null, 2) + '\n')
  console.log('\n✓ wrote apps/web/deployed.testnet.json')
