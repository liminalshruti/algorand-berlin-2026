...
**Current demo beat:** ranked agents → router-settled pay shim (gap in red if settled > quoted) → validate (verdict + reputation delta) → re-run shows trust penalty in ranking.
